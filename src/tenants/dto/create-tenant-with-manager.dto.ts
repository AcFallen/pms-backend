...
export class CreateTenantWithManagerDto {
  // ========================================
  ...
  @ApiProperty({
    ...
    enum: TenantPlan,
    example: TenantPlan.PREMIUM,
    default: TenantPlan.PREMIUM,
    required: false,
  })
  @IsEnum(TenantPlan)
  @IsOptional()
  ...
  // ========================================
  // FIRST MANAGER USER FIELDS (Required)
  // ========================================
  ...
  @ApiProperty({
    ...
    example: 'manager@hotelparadise.com',
    maxLength: 255,
  })
  @IsEmail()
  @IsNotEmpty()
